...
class RegistroActivity : AppCompatActivity() {
    ...
    private fun validarDatos() {
        ...
        if (nombre_usuario.isEmpty()){
            Toast.makeText(applicationContext, "Introduce nombre de usuario", Toast.LENGTH_SHORT).show()
        }
        else if (email.isEmpty()){
            Toast.makeText(applicationContext, "Introduce un correo", Toast.LENGTH_SHORT).show()
        }
        else if (password.isEmpty()){
            Toast.makeText(applicationContext, "Introduce una contraseña", Toast.LENGTH_SHORT).show()
        }
