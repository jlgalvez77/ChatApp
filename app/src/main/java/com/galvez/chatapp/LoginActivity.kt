...
class LoginActivity : AppCompatActivity() {
    ...
    private fun ValidarDatos() {
        ...
        if(email.isEmpty()){
            Toast.makeText(applicationContext, "Introduce tu dirección de correo electrónico", Toast.LENGTH_SHORT).show()
        }
        if(password.isEmpty()){
            Toast.makeText(applicationContext, "Introduce la contraseña", Toast.LENGTH_SHORT).show()
        }
        else {
